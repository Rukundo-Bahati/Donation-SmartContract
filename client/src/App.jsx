// App.js (React JavaScript, not TypeScript)
...
const App = () => {
  ...
  const handleRelease = async () => {
    try {
      const amountInWei = web3.utils.toWei("0.1", "ether"); // Example amount
  ...
  return (
<div className="App">
  <h1>📈 Decentralized <span style={{ backgroundColor: '#a0b0ff' }}>Scholarship</span> Funding</h1>
